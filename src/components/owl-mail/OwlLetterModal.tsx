...
export function OwlLetterModal({
  ...
  return (
    <div
      className="fixed inset-0 z-[60] overflow-y-auto overscroll-none bg-void/85 px-3 py-6 backdrop-blur-sm sm:px-4 sm:py-8"
      role="dialog"
      aria-modal
    ...
    >
      <div className="flex min-h-full items-start justify-center sm:items-center">
        <div
          className="owl-letter-unfurl relative w-full max-w-md overflow-visible pt-2"
          onClick={(e) => e.stopPropagation()}
        >
          {/* 貓頭鷹放在文書流裡，避免 absolute 被手機頂部裁切 */}
          <div className="pointer-events-none relative z-20 mx-auto -mb-8 w-24 sm:-mb-10 sm:w-28">
            <OwlCourierArt className="h-auto w-full drop-shadow-lg" />
          </div>

          <article className="owl-parchment relative z-10 overflow-hidden rounded-sm px-5 pb-8 pt-12 sm:px-7">
            <button
              type="button"
              onClick={onClose}
            ...
            <div
              className="max-h-[min(45vh,20rem)] overflow-y-auto overscroll-contain pr-1 sm:max-h-[min(50vh,22rem)]"
